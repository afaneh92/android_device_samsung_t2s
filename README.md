...
Supported Models
-------------
Galaxy S21 Plus (Exynos): G996B and G996N.

Download & Guide
-------------
                
1. Unlock your bootloader.
2. Downloads for Galaxy S21 Plus (Exynos): [t2s](https://www.androidfilehost.com/?w=files&flid=323764)
3. Reboot to download mode
4. Uncheck auto reboot in Odin and flash TWRP in AP slot and [vbmeta_disabled.tar](https://github.com/afaneh92/android_device_samsung_t2s/raw/github.io/docs/vbmeta_disabled.tar) in USERDATA slot.
...
[Device tree](https://github.com/afaneh92/android_device_samsung_t2s)

Changelog
-------------
[GitHub History](https://github.com/afaneh92/android_device_samsung_t2s/commits/android-11)
