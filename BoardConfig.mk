...
BOARD_PREBUILT_DTBOIMAGE := device/samsung/t2s/prebuilt/recoverydtbo
...
BOARD_MKBOOTIMG_ARGS += --header_version $(BOARD_BOOT_HEADER_VERSION) --pagesize $(BOARD_KERNEL_PAGESIZE) --board "SRPTG24B001RU"
