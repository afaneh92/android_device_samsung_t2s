...
# Kernel
TARGET_PREBUILT_KERNEL := device/samsung/t2s/prebuilt/Image
TARGET_PREBUILT_DTB := device/samsung/t2s/prebuilt/dtb
BOARD_PREBUILT_DTBOIMAGE := device/samsung/t2s/prebuilt/recovery_dtbo
...
BOARD_MKBOOTIMG_ARGS += --header_version $(BOARD_BOOT_HEADER_VERSION) --pagesize $(BOARD_KERNEL_PAGESIZE) --board "SRPTG24B005RU"
BOARD_MKBOOTIMG_ARGS += --dtb $(TARGET_PREBUILT_DTB) --dtb_offset $(BOARD_DTB_OFFSET)
BOARD_CUSTOM_BOOTIMG_MK := device/samsung/t2s/bootimg.mk
